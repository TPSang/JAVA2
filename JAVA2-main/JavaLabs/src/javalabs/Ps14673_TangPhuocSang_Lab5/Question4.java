...
public class Question4 extends javax.swing.JFrame {
     ...
     */
    public Question4(int quizas,int marks) {
        initComponents();
        this.quizas = quizas;
        this.marks = marks;
    }
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Sắp xếp các số: 0 , 5 , 2 , 10 theo thứ tự từ bé đến lớn:");

        btnGroup1.add(jrbtn1);
        jrbtn1.setText("10,5,2,0");

        btnGroup1.add(jrbtn3);
        jrbtn3.setText("5,2,10,0");

        btnGroup1.add(jrbtn2);
        jrbtn2.setText("2,0,10,5");

        btnGroup1.add(jrbtn4);
        jrbtn4.setText("0,2,5,10");
     ...
     if(!jrbtn1.isSelected() && !jrbtn2.isSelected() && !jrbtn3.isSelected() && !jrbtn4.isSelected()) {
       ...
       //khi nguoi dung chon cau tra loi dung
         if(jrbtn4.isSelected()){
             ...
             lblAnswerStatus.setText("inCorrect - Answer is 0,2,5,10");
    ...
    private void btnSubmitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSubmitActionPerformed
      ...
      if(!jrbtn1.isSelected() && !jrbtn2.isSelected() && !jrbtn3.isSelected() && !jrbtn4.isSelected()) {
         JOptionPane.showMessageDialog(null, "Please Select and answer");
          ...
          quizas = quizas + 1;
          // chuyen doi tab
          new Question5(quizas, marks).setVisible(true);
          this.dispose();
      }
