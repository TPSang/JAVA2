    ...
    public void add() {
        ...
        try {
            ...
            if (nv.tuoi >= 16 && nv.tuoi <= 55) {
                ...
                JOptionPane.showMessageDialog(this, "mời bạn nhập lại tuổi .. từ 16 > 55 \n"
                        + "chưa 16 tuổi ai cho ký hợp đồng ?");
                return;
            }
        ...
        try {
            ...
            if (nv.gmail.matches(pattern)) {
                ...
                JOptionPane.showMessageDialog(this, "mời bạn nhập lại (biết gmail mình không đó ? ) ");
                txtgmail.setText("");
                return;
            }
        } catch (Exception e) {
        ...
        try {
            ...
            if (nv.luong > 5000000) {
                ...
                txtluong.setText("");
                JOptionPane.showMessageDialog(this, "lương phải trên 5 củ khoai nhé !!!");
                return;
            }
...
//    }
    ...
    public void save() {
        ...
        try {
            fos = new FileOutputStream("D:\\JAVA2-main\\data.txt");
    ...
    public void open() {
        try {
            fis = new FileInputStream("D:\\JAVA2-main\\data.txt");
        ...
        try {
            ...
            for (NhanVien nv : listdsnv) {
                Object[] row = new Object[]{
                    nv.maNhanVien, nv.hoVaTen, nv.pb, nv.tuoi, nv.gmail, nv.luong,nv.getPb()
                };
                model.addRow(row);
            }
        } catch (Exception e) {
    ...
    public void fillToTable(){
        ...
        for(int i = 0; i <quanly.danhsach.size();i++){
            Object[] row = new Object[]{quanly.danhsach.get(i).getMaNhanVien(),quanly.danhsach.get(i).getHoVaTen(),
            quanly.danhsach.get(i).getTuoi(),quanly.danhsach.get(i).getGmail(),quanly.danhsach.get(i).getLuong(),quanly.danhsach.get(i).getPb()};
            model.addRow(row);
        }
    }
//    private void search() {
