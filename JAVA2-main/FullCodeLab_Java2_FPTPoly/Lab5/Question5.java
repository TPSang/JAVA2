...
public class Question5 extends javax.swing.JFrame {
     ...
     */
    public Question5(int quizas,int marks) {
        initComponents();
        this.quizas = quizas;
        this.marks = marks;
    }
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Số cần điền vào: 7 + 1 > …. + 2 là ?");
     ...
     if(!jrbtn1.isSelected() && !jrbtn2.isSelected() && !jrbtn3.isSelected() && !jrbtn4.isSelected()) {
       ...
       //khi nguoi dung chon cau tra loi dung
         if(jrbtn1.isSelected()){
             ...
             lblAnswerStatus.setText("inCorrect - Answer is 5");
    ...
    private void btnSubmitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSubmitActionPerformed
      ...
      if(!jrbtn1.isSelected() && !jrbtn2.isSelected() && !jrbtn3.isSelected() && !jrbtn4.isSelected()) {
         JOptionPane.showMessageDialog(null, "Please Select and answer");
          ...
          quizas = quizas + 1;
          // chuyen doi tab
          new Result_Question(quizas, marks).setVisible(true);
          this.dispose();
      }
